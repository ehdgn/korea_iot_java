...
public class Exception02 {
    public static void main(String[] args) {
        ...
        // at org.example.chapter09.Exception02.main(Exception02.java:31)
        ...
        try {
            ...
            // 3)
            String text = null;
            System.out.println(text.length()); // 문자열.lenth(): 문자열 길이를 반환

        } catch (ArithmeticException e) {
            System.out.println("수학 공식 예외: " + e.getMessage());
        } catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("배열 인덱스 초과 예외: " + e.getMessage());
            // 배열 인덱스 초과 예외: Index 10 out of bounds for length 5
