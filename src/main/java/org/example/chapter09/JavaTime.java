...
public class JavaTime {
    public static void main(String[] args) {
        ...
        System.out.println(onMonthAgo); // 2025-06-09

        // 2) 시간
        LocalTime now = LocalTime.now();
        System.out.println(now); // 16:33:10.171278800

        LocalTime lunchTime = LocalTime.of(12,50); // of (시, 분) || of (시, 분, 초)
        System.out.println(lunchTime); // 12:50

        // .plus(Hours, Minus, Seconds)
        // .minus(동일)

        // 3) 날짜 & 시간
        // .now(), .of(), .plus~(), .minus~()
        LocalDateTime nowDateTime = LocalDateTime.now();
        System.out.println(nowDateTime); // 2025-07-09T16:35:38.950727600
        ...
        System.out.println(example); // 2025-07-09T16:39:29.062763
        ...
        System.out.println(example.format(formatter)); // 25-07-09 16:45:19
    }
}
