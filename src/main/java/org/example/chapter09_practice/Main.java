...
public class Main {
    public static void main(String[] args) {
        ...
        // 사용자 추가
        userService.addUser(new User(1,"권민현","qwe123@example.com10"));
        userService.addUser(new User(2,"안미향","asd123@example.com10"));
        userService.addUser(new User(3,"김승민","uio123@example.com10"));
