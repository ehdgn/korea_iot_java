...
*           >> App.java가 사용자 입력처리, 메뉴 출력, 흐름제어 모두 담당 -> SRP 위반 (단일 책임 원칙)
    ...
    private static boolean processChoice(int choice) {
        switch (choice) {
            ...
            case 4:
            {
                ...
                patientController.updatePatients(id, requestDto);
                break;
            }
            case 5:
            {
            ...
            case 8:
            {
                ...
                List<RecordListResponseDto> filteredRecords = healthRecordController.filterRecordByDiagnosis(diagnosisFilter);
