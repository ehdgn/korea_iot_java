...
/*
    ...
    - 데이털 필터링, 매핑, 변환, 집계 등 다양한 작업 수행
    - 람다식과 결합하여 가독성 높은 코드 작성 가능

    1. 스트림의 3단계 구조 (데이터 파이프라인)
    : 스트림은 데이터를 소르로 부터 연속적으로 처리하는 '파이프 라인' 구축
...
//                .collect(Collectors.groupingBy(String::length));
        ...
        grouped.forEach((length,group) -> System.out.println(length + "글자" + group));
    }
