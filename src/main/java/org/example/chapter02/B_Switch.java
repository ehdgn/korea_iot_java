...
public class B_Switch {
    public static void main(String[] args) {
        ...
        scanner.nextLine(); // 개행 문자(Enter) 정리
        ...
        int score = 85;
        if (score >= 90) System.out.println("우수한 성적 입니다.");
        else if (score >= 70) System.out.println("평균적인 성적입니다.");
        else System.out.println("조금 더 노력해봅시다.");
