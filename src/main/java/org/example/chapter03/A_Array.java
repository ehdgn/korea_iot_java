...
// == 클래스 == //
// : 파일 (코드 저장소)
// : 한 개의 .java(자바) 파일에는 한마의 클래스가 포함(파일명과 동일)
// - 모든 코드가 클래스 안에서 동작
public class A_Array { // 클래스명 == 파일명 (파일명은 대문자로 시작! + UpperCamelCase 사용)
    ...
    public static void main(String[] args) {
        ...
        // cf) 참조 자료형 - 주소값이 저장
        // : 데이터 배열이 저장된 첫 번째 메머리 주소가 저장 (인덱스번호 0번의 주소)
        ...
        // == 배열의 선언과 동시에 초기화 == //
        // : new 연산자 사용 + 직접적인 요소를 대입하여 배열 생성 시 길이 지정 X
        ...
        System.out.println(arr2); // abc - char는 문자열처럼 자동처리
