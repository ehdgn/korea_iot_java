...
// === 롬복(Lombok) 라이브러리 === //
// : 자바에서 반복적으로 작성해야 하는 보일러플레이트(boilerplate) 코드를 줄여주는 라이브러리
...
// 4. Data 어노테이션
// @Getter, @Setter, @ToString, @RequiredConstructor, @EqualsAndHashCode 어노테이션을 한번에 적용하는 어노테이션
