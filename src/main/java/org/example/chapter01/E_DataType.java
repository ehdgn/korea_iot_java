    ...
    public static void main(String[] args) {
        /*
           ...
           : 자바 '강' 타입 언어
               ...
               cf) Stack(스택) : 기본 타입의 데이터가 실제 저장 / 참조타입의 주소값이 저장
        ...
        double d1 = 123.4567890123456789; // 123.45678901234568
        ...
        // 2-1) 문자열(String)
        // : 문자열(문자 여러개)을 저장하는 데 사용
        // : 반드시! 쌍따옴표(큰타옴표)를 사용하여 문자열 작성
        ...
        String studentName = "김동후";
        int studentAge = 26;
        double studentHeight = 177.3;
